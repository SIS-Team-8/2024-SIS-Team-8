    ...
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route path="/mood-selection/:date" element={isAuthenticated ? <MoodSelection theme={theme} toggleTheme={toggleTheme} language={language} setLanguage={handleLanguageChange} onMoodUpdate={handleMoodUpdate2} moodData={moodData} /> : <Login onLogin={handleLogin} />} />
