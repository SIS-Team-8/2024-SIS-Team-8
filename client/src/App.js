    ...
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route path="/mood-selection" element={isAuthenticated ? <MoodSelection theme={theme} toggleTheme={toggleTheme} language={language} setLanguage={handleLanguageChange} updateEntry={updateEntry} moodData={moodData} /> : <Login onLogin={handleLogin} />} />
